...
{
    public partial class LoginSef : Form
    {
        public LoginSef()
        {
            InitializeComponent();
        ...
        bool Login()
        {
            ...
            _veri.Query("select count(*) from Chef where TC=@TC and Password=@Password");
        ...
        private void ButtonGiris_Click(object sender, EventArgs e)
        {
            ...
            if (Login() == true)
            {
                SqlCommand login = new SqlCommand("select * from Chef where tc=" + GirisTC.Text, baglantim);
                ...
                gitSefAnaSayfa.ShowDialog();
            }
            baglantim.Close();
        }

        bool hareket; int mouseX; int mouseY;
        private void LoginSef_MouseDown(object sender, MouseEventArgs e)
        {
            hareket = true;
            mouseX = e.X;
            mouseY = e.Y;
        ...
        private void LoginSef_MouseUp(object sender, MouseEventArgs e)
        {
            hareket = false;
        }

        private void LoginSef_MouseMove(object sender, MouseEventArgs e)
        {
            if (hareket == true)
            {
